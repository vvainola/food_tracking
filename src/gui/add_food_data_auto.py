...
class Ui_add_food_form(object):
    def setupUi(self, add_food_form):
        ...
        self.table_food_data.setGeometry(QtCore.QRect(0, 0, 241, 371))
        ...
        self.table_food_data.setRowCount(8)
        ...
        self.btn_cancel.setGeometry(QtCore.QRect(10, 380, 91, 41))
        self.btn_cancel.setObjectName("btn_cancel")
        self.btn_ok = QtWidgets.QPushButton(self.centralwidget)
        self.btn_ok.setGeometry(QtCore.QRect(120, 380, 61, 41))
    ...
    def retranslateUi(self, add_food_form):
        ...
        item.setText(_translate("add_food_form", "Code"))
